...
<!--        <?php if ( get_header_image() ) : ?>
 ...
 <!--<a href="#head" title="¬верх"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/UpButoon.png" alt="" id="UpButton" class="UpButtonn"/> </a>
-->
...
<div class="inHeader">
    	<div id="site-header">
    		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
    		   <!--	<img src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
    			-->
                <img class="headerlogo" id="headerlogo" src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/logokurt5.png "   alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"/>
    		</a>
    	</div>
